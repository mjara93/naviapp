    ...
    a.fn.smartWizard = function(m) {
        ...
        return this.each(function() {
            function C() {
                ...
                //s = a("<a>" + c.labelFinish + "</a>").attr("href", "#").addClass("btn btn-primary pull-right").data("box", "#message-box-info");
                s = a("<button type='button' class='btn btn-primary pull-right mb-control' data-box='#message-box-info'>" + c.labelFinish + "</button>");
